// Autogenerated by git@github.com:jorgecarleitao/thrift.git
// hash 06738830064e50aff50420add1636187eced1c98
// ../thrift/compiler/cpp/cmake-build/bin/thrift --gen rs parquet.thrift && mv parquet.rs src/parquet_format.rs && sed -i 's/thrift::/crate::thrift::/' src/parquet_format.rs
...
impl Type {
  ...
  pub fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> crate::thrift::Result<usize> {
    o_prot.write_i32(self.0)
  }
  #[allow(clippy::trivially_copy_pass_by_ref)]
  pub async fn write_to_out_stream_protocol(&self, o_prot: &mut dyn TOutputStreamProtocol) -> crate::thrift::Result<usize> {
...
impl ColumnMetaData {
  ...
  pub fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> crate::thrift::Result<usize> {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::I32, self.encodings.len() as i32))?;
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::String, self.path_in_schema.len() as i32))?;
    ...
    if let Some(ref fld_var) = self.key_value_metadata {
      ...
      written += o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, fld_var.len() as i32))?;
      for e in fld_var {
        written += e.write_to_out_protocol(o_prot)?;
      }
      written += o_prot.write_list_end()?;
  ...
  pub async fn write_to_out_stream_protocol(&self, o_prot: &mut dyn TOutputStreamProtocol) -> crate::thrift::Result<usize> {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::I32, self.encodings.len() as i32)).await?;
    for e in &self.encodings {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::String, self.path_in_schema.len() as i32)).await?;
    for e in &self.path_in_schema {
    ...
    if let Some(ref fld_var) = self.key_value_metadata {
      ...
      written += o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, fld_var.len() as i32)).await?;
      for e in fld_var {
        written += e.write_to_out_stream_protocol(o_prot).await?;
      }
      written += o_prot.write_list_end().await?;
...
impl RowGroup {
  ...
  pub fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> crate::thrift::Result<usize> {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, self.columns.len() as i32))?;
  ...
  pub async fn write_to_out_stream_protocol(&self, o_prot: &mut dyn TOutputStreamProtocol) -> crate::thrift::Result<usize> {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, self.columns.len() as i32)).await?;
    for e in &self.columns {
      written += e.write_to_out_stream_protocol(o_prot).await?;
    }
    written += o_prot.write_list_end().await?;
...
impl OffsetIndex {
  ...
  pub fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> crate::thrift::Result<usize> {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, self.page_locations.len() as i32))?;
  ...
  pub async fn write_to_out_stream_protocol(&self, o_prot: &mut dyn TOutputStreamProtocol) -> crate::thrift::Result<usize> {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, self.page_locations.len() as i32)).await?;
    for e in &self.page_locations {
      written += e.write_to_out_stream_protocol(o_prot).await?;
    }
    written += o_prot.write_list_end().await?;
...
impl ColumnIndex {
  ...
  pub fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> crate::thrift::Result<usize> {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::Bool, self.null_pages.len() as i32))?;
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::String, self.min_values.len() as i32))?;
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::String, self.max_values.len() as i32))?;
    ...
    if let Some(ref fld_var) = self.null_counts {
      ...
      written += o_prot.write_list_begin(&TListIdentifier::new(TType::I64, fld_var.len() as i32))?;
      for e in fld_var {
  ...
  pub async fn write_to_out_stream_protocol(&self, o_prot: &mut dyn TOutputStreamProtocol) -> crate::thrift::Result<usize> {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::Bool, self.null_pages.len() as i32)).await?;
    for e in &self.null_pages {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::String, self.min_values.len() as i32)).await?;
    for e in &self.min_values {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::String, self.max_values.len() as i32)).await?;
    for e in &self.max_values {
      written += o_prot.write_bytes(e).await?;
    }
    written += o_prot.write_list_end().await?;
    ...
    if let Some(ref fld_var) = self.null_counts {
      ...
      written += o_prot.write_list_begin(&TListIdentifier::new(TType::I64, fld_var.len() as i32)).await?;
      for e in fld_var {
...
impl FileMetaData {
  ...
  pub fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> crate::thrift::Result<usize> {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, self.schema.len() as i32))?;
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, self.row_groups.len() as i32))?;
  ...
  pub async fn write_to_out_stream_protocol(&self, o_prot: &mut dyn TOutputStreamProtocol) -> crate::thrift::Result<usize> {
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, self.schema.len() as i32)).await?;
    for e in &self.schema {
      written += e.write_to_out_stream_protocol(o_prot).await?;
    }
    written += o_prot.write_list_end().await?;
    ...
    written += o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, self.row_groups.len() as i32)).await?;
    for e in &self.row_groups {
      written += e.write_to_out_stream_protocol(o_prot).await?;
    }
    written += o_prot.write_list_end().await?;
